...
style precedent; travels with the rest of `.claude/`, not standalone.
...
Run this project's actual build/test commands (see `CLAUDE.md`) before the
...
5. Docs: Records the new folder categories in CLAUDE.md
```
